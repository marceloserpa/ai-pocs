...
def search(query, number_of_results=14):
...
docs_to_rerank = initial_results['texts'].tolist()
results = co.rerank(query=query, documents=docs_to_rerank, model="rerank-english-v3.0", top_n=3, return_documents=True)
